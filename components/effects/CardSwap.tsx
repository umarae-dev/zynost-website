...
/** Ported from React Bits' CardSwap (JS-CSS variant) — a GSAP-driven 3D
 * stacked-card auto-swap, unchanged algorithm from the canonical source,
 * typed for this codebase. */
const CardSwap = ({
  width = 500,
  height = 400,
  cardDistance = 60,
  ...
  const rendered = childArr.map((child, i) =>
    isValidElement(child)
      ? cloneElement(child as ReactElement<React.HTMLAttributes<HTMLDivElement>>, {
          key: i,
          ref: refs[i],
